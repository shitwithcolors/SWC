...
AudioVisualizer.prototype.initialize = function () {
    ...
    var secLight = new THREE.PointLight(0xffffff);
    secLight.position.set(100, -400, 100);
...
AudioVisualizer.prototype.createBars = function () {
    ...
    for (var i = 0; i < this.numberOfBars; i++) {
        ...
        //create a bar
        var barGeometry = new THREE.BoxGeometry(0.1, 50.0, 0.5);
        ...
        this.bars[i].position.set(i - this.numberOfBars/2, 10, 0);
